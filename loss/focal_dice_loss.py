...
class FocalLoss(nn.Module):
    ...
    Examples:
        ...
        >>> output.backward()
    """
    def __init__(self, gamma=0, alpha: List[float] = None, weights={'focal': 0.75, 'dice': 0.25}, reduction="none"):
    ...
    def forward(self, input, target):
        ...
        dice_loss = dice_loss(input, target, reduction=self.reduction)
        loss = self.weights['focal'] * loss + self.weights['dice'] * dice_loss
